                        ...
                        <div class="card-body">
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('auth/login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="login-email" class="form-label">{{ __('Emel Atau No. IC') }}</label>
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="login-email" name="nokp" placeholder="xxx@xxxx.com" value="{{ old('email') }}" aria-describedby="login-email" tabindex="1" required autofocus/>
                                </div>
