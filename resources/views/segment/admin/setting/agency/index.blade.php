...
@section('content')
            ...
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="agency-table table">
                                    <thead>
                                    <tr>
                                        <th></th>
                                        <th>Nama</th>
    ...
    @include('segment.admin.setting.agency.modal.modal')
@endsection

@section('customJS')
    {{--  Vendor files  --}}
    @include('segment.layouts.asset_include_links.datatable.js.datatable_js')
    @include('segment.layouts.asset_include_links.datatable.js.datatable_treegrid')
    ...
    {{--  Custom files  --}}
    <script src="{{ asset('js_helper/segment/admin/setting/agency/page_settings.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/setting/agency/index.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/setting/agency/datatable.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/setting/agency/ajax.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/setting/agency/swal.js') }}"></script>
@endsection
