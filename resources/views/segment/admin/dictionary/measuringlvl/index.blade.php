...
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Measuring Level</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Measuring Level
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    @include('segment.admin.dictionary.measuringlvl.modals.index')
@endsection
...
@section('customJS')
    ...
    {{--  Custom files  --}}
    <script src="{{ asset('js_helper/segment/admin/dictionary/measuringlvl/swal.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/measuringlvl/page_settings.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/measuringlvl/datatable.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/measuringlvl/ajax.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/measuringlvl/index.js') }}"></script>
