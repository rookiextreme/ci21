...
@section('content')
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active"><a href="#">Listing</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <table class="dict-listing-table table">
                                    <thead>
                                    <tr>
                                        <th>Nama</th>
                                        <th>M. Level</th>
    ...
    @include('segment.admin.dictionary.collection.modals.index')
@endsection
...
@section('customJS')
    ...
    {{--  Custom files  --}}
    <script src="{{ asset('js_helper/segment/admin/dictionary/collection/swal.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/collection/page_settings.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/collection/datatable.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/collection/ajax.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/collection/index.js') }}"></script>
