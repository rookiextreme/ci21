        ...
        <div class="content-body">
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <table class="question-bank-table table">
                                <thead>
                                    <tr>
                                        <th>Tajuk</th>
                                        <th>Tarikh Mula</th>
...
@section('customJS')
    ...
    {{--  Custom files  --}}
    <script src="{{ asset('js_helper/segment/admin/dictionary/question/swal.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/question/page_settings.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/question/datatable.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/question/ajax.js') }}"></script>
    <script src="{{ asset('js_helper/segment/admin/dictionary/question/index.js') }}"></script>
@endsection