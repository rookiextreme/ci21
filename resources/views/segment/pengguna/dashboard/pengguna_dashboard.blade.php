                                            ...
                                            <li class="timeline-item">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        ...
                                                        @if($d['penilaian']['penyelia'])
                                                            <p>Penyelia Anda Adalah: </p>
                                                            <p><b>{{$d['penilaian']['penyelia']}}</b></p>
                                                        @else
                                                            <p>Anda Belum Memilih Penyelia</p>
                                                        @endif
                                                        <p><a href="#">Tukar Penyelia</a></p>
                                                    </div>
                                                    @if($d['penilaian']['penyelia'])
                                                        <div class="col-md-5">
                                            ...
                                            <li class="timeline-item">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        ...
                                                        @if($d['penilaian']['jobgroup'])
                                                            <p>Job Group Anda Adalah: </p>
                                                            <p><b>$d['penilaian']['jobgroup']</b></p>
                                                        @else
                                                            <p>Anda Belum Memilih Job Group </p>
                                                        @endif

                                                        <p><a href="#">Tukar Job Group</a></p>
                                                    </div>
                                                    @if($d['penilaian']['jobgroup'])
                                                        <div class="col-md-5">
                                                            <img src="{{Request::root()}}/basicImg/tick.jpg" alt="" width="70px" height="70px" style="float: right">
                                            ...
                                            <li class="timeline-item">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        ...
                                                        @if($d['penilaian']['penyelia'] && $d['penilaian']['jobgroup'])
                                                            <p>Anda Telah Berjaya Melengkapkan Penilaian Kompetensi Ini</p>
                                                            <p><a href="#">Jawab Penilaian</a></p>
                                                        @else
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tr style="">
                                                ...
                                                <th class="centerCell">Tindakan</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            @if(!empty($d['penilaian']['competencies']))
                                                @foreach($d['penilaian']['competencies'] as $c)
                                                    <tr data-penilaian-competency-id="{{$c['id']}}">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-icon btn-outline-warning"><i data-feather="edit"></i></button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @else
