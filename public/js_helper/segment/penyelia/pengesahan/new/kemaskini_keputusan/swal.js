...
function swalAjaxFire(postData){
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(postfunc == 0){
                if(success == 1){
                    swalPostFire('success', 'Berjaya Dihantar', 'Penilaian Telah Disahkan');
                    window.location.href = getUrl() + '/penyelia/pengesahan/result/' + parseData.profiles_id + '/' + parseData.penilaian_id;
                }
                $.unblockUI();
            }
        }
