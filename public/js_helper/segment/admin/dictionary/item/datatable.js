let bank_id = $('#hdn_dict_bank_id').val();

$('.item-bank-table').DataTable({
    processing: true,
    serverSide: true,
    ajax: getUrl() + '/admin/dictionary/bank/item/item-datalist/'+bank_id,
    lengthChange:true,
    columns: [
        { data: 'measuring_level' },
        ...
        },*/
        {
            ...
            render: function (data, type, full, meta) {
                return (
                    ...
                    '<button type="button" class="btn btn-icon btn-outline-danger mr-1 mb-1 waves-effect waves-light delete-bank-item">'+ feather.icons['trash-2'].toSvg() +'</button>'
                );
            }
        }
    ],
...
$('.tbl-col-item').DataTable({
                processing: true,
                serverSide: true,
                ajax: getUrl() + '/admin/dictionary/bank/item/list/col-datalist',
                lengthChange:true,
                columns: [
                    { data: 'name' },
                    { data: 'measure' },
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                 '<button type="button" class="btn btn-icon btn-outline-info mr-1 mb-1 waves-effect waves-light add-col-item">'+ feather.icons['plus'].toSvg() +'</button>'
