$(document).on('click', '.update-score', function(){
    ...
    window.location.href = getUrl() + '/admin/dictionary/bank/penilaian/job-group/score/' + job_group_id;
})
...
$(document).on('click', '.show-soalan-page', function(){
    window.location.href = getUrl() + '/admin/dictionary/bank/penilaian/config/items/' + $('.penilaian_id').val();
})
